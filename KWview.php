...
class KWview extends KWmodel
{
  ...
  function show( $what, $how='initialen' )
  {
	...
	<!--img class="img18" src="images/Copy-18px.png" alt="KW kopieren" usemap="#kopierenKW<?php echo $ancor;?>"-->
        ...
        <img class="img18" src="images/iconmonstr-arrow-72-16.png" alt="zur&uuml;ck" usemap="#zurueck<?php echo $ancor;?>">
	...
	<button class="dropbtn">KW<?php echo $this->Kalenderwoche;?></button>
	  <div class="dropdown-content">
        ...
        <img class="img18" src="images/iconmonstr-arrow-10-16.png" alt="weiter" usemap="#weiter<?php echo $ancor;?>">
	...
	{ // keine Start-VS, oder: nix gfundn worn :-(
	  if( isset($_REQUEST['d']) )
	    ...
	    $d="";
          ?><a href="mn.php?mn=planend&a=Termin&sl=5&sl1=Leistung&sl2=Trainer&sl3=Ort&sl4=<?php echo $row;?>&sl5=<?php echo $i;?>&navi=Plan&u=KW<?php echo $this->Kalenderwoche;?>&k=<?php echo $this->Kalenderwoche;?>&j=<?php echo $this->Jahr . $d;?>&planungVS_x&i=3" target="_blank" title="<?php echo $dayofweek . " " . $quart[$row];?>">&nbsp;</a>&nbsp;<?php
	  /***
